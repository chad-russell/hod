//! Minimal Niri desktop profile for Hod OS.
//!
//! This is intentionally smaller than a full desktop environment. Niri provides
//! the compositor/window manager; Hod supplies a terminal and a small generated
//! config in the VM image builder.
