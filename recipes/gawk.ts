...
import { gawkSourceRecipe } from "../shims/gawk-source.js";
...
# Configure gawk as cross-compile
...
# Strip binaries
/deps/seed/bin/strip $OUT/bin/gawk $OUT/bin/gawk-5.3.2 2>/dev/null || true
...
rm -rf $OUT/share $OUT/include $OUT/lib $OUT/etc $OUT/sbin 2>/dev/null || true`,
  ...
  dependencies: [
    ...
    dep("source", gawkSourceRecipe),
  ],
});

await importToStore(recipe);
export const gawkRecipe = recipe;
