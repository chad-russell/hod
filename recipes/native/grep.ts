...
# Strip binaries
/deps/seed/bin/strip $OUT/bin/grep $OUT/bin/egrep $OUT/bin/fgrep 2>/dev/null || true
...
rm -rf $OUT/share $OUT/include $OUT/lib $OUT/etc $OUT/sbin 2>/dev/null || true`,
  ...
  dependencies: [
    ...
    dep("source", grepSourceRecipe),
  ],
});

await importToStore(recipe);
export const grepRecipe = recipe;
