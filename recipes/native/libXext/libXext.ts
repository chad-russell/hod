//! libXext build recipe — X11 miscellaneous extensions library.
//!
//! Builds libXext 1.3.6. Part of the GTK3 X11 extension stack.

import { shellBuild, dep, importToStore } from "../../../js/src/index.js";
import { nativeToolchainRecipe } from "../../toolchain/native-toolchain.js";
import { xorgprotoRecipe } from "../xorgproto/xorgproto.js";
import { libXextSourceRecipe } from "./libXext-source.js";
...
export const libXextRuntimeDeps = ["libX11", "libXau", "libXcb", "libXdmcp", "toolchain"];
...
`,
  deps: [
    dep("source", libXextSourceRecipe),
  ...
  runtime_deps: libXextRuntimeDeps,
});

await importToStore(recipe);
export const libXextRecipe = recipe;
