//! libXi build recipe — X Input extension library.
//!
//! Builds libXi 1.8.2. Part of the GTK3 X11 extension stack.

import { shellBuild, dep, importToStore } from "../../../js/src/index.js";
import { nativeToolchainRecipe } from "../../toolchain/native-toolchain.js";
import { xorgprotoRecipe } from "../xorgproto/xorgproto.js";
import { libXiSourceRecipe } from "./libXi-source.js";
...
export const libXiRuntimeDeps = ["libX11", "libXau", "libXcb", "libXdmcp", "libXext", "libXfixes", "toolchain"];

const recipe = await shellBuild({
  ...cProfile({
    includeDeps: ["xorgproto", "libX11", "libXext", "libXfixes", "libXau", "libXcb", "libXdmcp"],
    libDeps: ["libX11", "libXext", "libXfixes", "libXau", "libXcb", "libXdmcp"],
    pkgConfigDeps: ["libX11", "libXext", "libXfixes", "libXau", "libXcb", "libXdmcp"],
...
`,
  ...
  runtime_deps: libXiRuntimeDeps,
});

await importToStore(recipe);
export const libXiRecipe = recipe;
