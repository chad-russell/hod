//! libXrandr build recipe — X Resize and Rotate extension library.
//!
//! Builds libXrandr 1.5.4. Part of the GTK3 X11 extension stack.

import { shellBuild, dep, importToStore } from "../../../js/src/index.js";
import { nativeToolchainRecipe } from "../../toolchain/native-toolchain.js";
import { xorgprotoRecipe } from "../xorgproto/xorgproto.js";
import { libXrandrSourceRecipe } from "./libXrandr-source.js";
...
export const libXrandrRuntimeDeps = ["libX11", "libXau", "libXcb", "libXdmcp", "libXext", "libXrender", "toolchain"];

const recipe = await shellBuild({
  ...cProfile({
    includeDeps: ["xorgproto", "libX11", "libXext", "libXrender", "libXau", "libXcb", "libXdmcp"],
    libDeps: ["libX11", "libXext", "libXrender", "libXau", "libXcb", "libXdmcp"],
    pkgConfigDeps: ["libX11", "libXext", "libXrender", "libXau", "libXcb", "libXdmcp"],
...
`,
  deps: [
    dep("source", libXrandrSourceRecipe),
  ...
  runtime_deps: libXrandrRuntimeDeps,
});

await importToStore(recipe);
export const libXrandrRecipe = recipe;
