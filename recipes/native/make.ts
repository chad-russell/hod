...
import { makeSourceRecipe } from "../shims/make-source.js";
...
# Configure make as cross-compile
...
# Strip the binary
/deps/seed/bin/strip $OUT/bin/make 2>/dev/null || true
