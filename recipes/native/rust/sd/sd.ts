//! sd native build recipe — intuitive find & replace CLI.
//!
//! Builds sd 1.1.0 from source using the prebuilt Rust toolchain.
...
//!
//! sd uses `edition = "2021"` and `rust-version = "1.74"`, both
...
//!
//! sd is a single dynamically-linked binary that needs the C toolchain's
