//! tealdeer native build recipe — fast tldr pages client.
//!
//! Builds tealdeer 1.7.1 from source using the prebuilt Rust toolchain.
...
//!
//! tealdeer's Cargo.toml uses `edition = "2021"` and `rust-version = "1.75"`,
//! both satisfied by Rust 1.95.0.
//!
//! Default features are used, which include `native-roots` (rustls with
//! native system cert loading). This compiles as pure Rust with no
//! additional C dependencies.
//!
//! The installed binary is named `tldr`.
//!
//! ## Note on hermeticity
//!
...
//!
//! tealdeer is a single dynamically-linked binary that needs the C
...
export const tealdeerRecipe = recipe;
